...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	$sourse = $_POST['sourse'];
	$puplisher = $_POST['publisher'];
	$sql = "SELECT author, title, rubric, keyword, person, geograf, sourse 
			FROM kray WHERE author LIKE '%$author%' AND title LIKE '%$title%' AND rubric LIKE '%$rubric%'  
...
$smarty->display(BIBL_PATH . '/templates/searchkray.tpl');
?>	
